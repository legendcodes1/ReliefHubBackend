              ...
              {exercises.map((routineExercise, index) => {
                ...
                return (
                  <article
                    ...
                    className={`rounded-2xl border bg-[color:var(--bg-soft)] p-4 shadow-sm transition ${
                      isVideoOpen
                        ? 'border-emerald-200 shadow-[0_18px_40px_rgba(15,118,110,0.12)]'
                  ...
                  >
                    ...
                    <div
                      className={`grid gap-4 md:items-start ${
                        isVideoOpen
                          ? 'lg:grid-cols-[minmax(0,2.2fr)_minmax(18rem,1fr)]'
                          : 'md:grid-cols-2'
                      }`}
                    >
                      <div>
