...
function handleRoutineError(error, res, fallbackMessage) {
...
export const getPublicRoutinesController = async (_req, res) => {
    try {
...
export const createRoutineController = async (req, res) => {
    try {
        ...
        const { name, exercise_ids, is_public } = req.body;
